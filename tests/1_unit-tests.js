...
suite('Unit Tests', () => {
  ...
  test('Translate Paracetamol takes up to an hour to work. to American English', () => {
    ...
    assert.equal(result.translation, '<span class="highlight">Acetaminophen</span> takes up to an hour to work.');
  ...
  test('Translate The car boot sale at Boxted Airfield was called off. to American English', () => {
    ...
    assert.equal(result.translation, 'The <span class="highlight">trunk sale</span> at Boxted Airfield was called off.');
    assert.include(result.translation, '<span class="highlight">trunk sale</span>');
  });
